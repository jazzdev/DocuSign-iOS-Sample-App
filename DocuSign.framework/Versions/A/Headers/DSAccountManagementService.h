...
@end
@class DSAccountManagementServiceSoapBindingResponse;
@class DSAccountManagementServiceSoapBindingOperation;
@protocol DSAccountManagementServiceSoapBindingResponseDelegate <NSObject>
- (void) operation:(DSAccountManagementServiceSoapBindingOperation *)operation completedWithResponse:(DSAccountManagementServiceSoapBindingResponse *)response;
@end
...
@interface DSAccountManagementServiceSoapBinding : NSObject <DSAccountManagementServiceSoapBindingResponseDelegate> {
	NSURL *address;
...
- (void)sendHTTPCallUsingBody:(NSString *)body soapAction:(NSString *)soapAction forOperation:(DSAccountManagementServiceSoapBindingOperation *)operation;
- (void)addCookie:(NSHTTPCookie *)toAdd;
- (NSString *)MIMEType;
- (DSAccountManagementServiceSoapBindingResponse *)UpgradeRecipientAccountUsingParameters:(DSAccountManagementService_UpgradeRecipientAccount *)aParameters ;
- (void)UpgradeRecipientAccountAsyncUsingParameters:(DSAccountManagementService_UpgradeRecipientAccount *)aParameters  delegate:(id<DSAccountManagementServiceSoapBindingResponseDelegate>)responseDelegate;
- (DSAccountManagementServiceSoapBindingResponse *)NewAccountUsingParameters:(DSAccountManagementService_NewAccount *)aParameters ;
- (void)NewAccountAsyncUsingParameters:(DSAccountManagementService_NewAccount *)aParameters  delegate:(id<DSAccountManagementServiceSoapBindingResponseDelegate>)responseDelegate;
- (DSAccountManagementServiceSoapBindingResponse *)AddMembersToAccountUsingParameters:(DSAccountManagementService_AddMembersToAccount *)aParameters ;
- (void)AddMembersToAccountAsyncUsingParameters:(DSAccountManagementService_AddMembersToAccount *)aParameters  delegate:(id<DSAccountManagementServiceSoapBindingResponseDelegate>)responseDelegate;
- (DSAccountManagementServiceSoapBindingResponse *)GetPlanPricingInformationUsingParameters:(DSAccountManagementService_GetPlanPricingInformation *)aParameters ;
- (void)GetPlanPricingInformationAsyncUsingParameters:(DSAccountManagementService_GetPlanPricingInformation *)aParameters  delegate:(id<DSAccountManagementServiceSoapBindingResponseDelegate>)responseDelegate;
- (DSAccountManagementServiceSoapBindingResponse *)GetSuccessorPlanInformationUsingParameters:(DSAccountManagementService_GetSuccessorPlanInformation *)aParameters ;
- (void)GetSuccessorPlanInformationAsyncUsingParameters:(DSAccountManagementService_GetSuccessorPlanInformation *)aParameters  delegate:(id<DSAccountManagementServiceSoapBindingResponseDelegate>)responseDelegate;
- (DSAccountManagementServiceSoapBindingResponse *)GetPlanGroupInformationUsingParameters:(DSAccountManagementService_GetPlanGroupInformation *)aParameters ;
- (void)GetPlanGroupInformationAsyncUsingParameters:(DSAccountManagementService_GetPlanGroupInformation *)aParameters  delegate:(id<DSAccountManagementServiceSoapBindingResponseDelegate>)responseDelegate;
- (DSAccountManagementServiceSoapBindingResponse *)GetMembershipSummaryUsingParameters:(DSAccountManagementService_GetMembershipSummary *)aParameters ;
- (void)GetMembershipSummaryAsyncUsingParameters:(DSAccountManagementService_GetMembershipSummary *)aParameters  delegate:(id<DSAccountManagementServiceSoapBindingResponseDelegate>)responseDelegate;
- (DSAccountManagementServiceSoapBindingResponse *)ChangeAccountPricePlanUsingParameters:(DSAccountManagementService_ChangeAccountPricePlan *)aParameters ;
- (void)ChangeAccountPricePlanAsyncUsingParameters:(DSAccountManagementService_ChangeAccountPricePlan *)aParameters  delegate:(id<DSAccountManagementServiceSoapBindingResponseDelegate>)responseDelegate;
- (DSAccountManagementServiceSoapBindingResponse *)GetProvisioningInformationUsingParameters:(DSAccountManagementService_GetProvisioningInformation *)aParameters ;
- (void)GetProvisioningInformationAsyncUsingParameters:(DSAccountManagementService_GetProvisioningInformation *)aParameters  delegate:(id<DSAccountManagementServiceSoapBindingResponseDelegate>)responseDelegate;
- (DSAccountManagementServiceSoapBindingResponse *)SetConnectCredentialsUsingParameters:(DSAccountManagementService_SetConnectCredentials *)aParameters ;
- (void)SetConnectCredentialsAsyncUsingParameters:(DSAccountManagementService_SetConnectCredentials *)aParameters  delegate:(id<DSAccountManagementServiceSoapBindingResponseDelegate>)responseDelegate;
- (DSAccountManagementServiceSoapBindingResponse *)GetPlanTypeUsingParameters:(DSAccountManagementService_GetPlanType *)aParameters ;
- (void)GetPlanTypeAsyncUsingParameters:(DSAccountManagementService_GetPlanType *)aParameters  delegate:(id<DSAccountManagementServiceSoapBindingResponseDelegate>)responseDelegate;
- (DSAccountManagementServiceSoapBindingResponse *)GetAccountInformationUsingParameters:(DSAccountManagementService_GetAccountInformation *)aParameters ;
- (void)GetAccountInformationAsyncUsingParameters:(DSAccountManagementService_GetAccountInformation *)aParameters  delegate:(id<DSAccountManagementServiceSoapBindingResponseDelegate>)responseDelegate;
- (DSAccountManagementServiceSoapBindingResponse *)GetAccountDistributorCodeUsingParameters:(DSAccountManagementService_GetAccountDistributorCode *)aParameters ;
- (void)GetAccountDistributorCodeAsyncUsingParameters:(DSAccountManagementService_GetAccountDistributorCode *)aParameters  delegate:(id<DSAccountManagementServiceSoapBindingResponseDelegate>)responseDelegate;
- (DSAccountManagementServiceSoapBindingResponse *)GetConnectCredentialsUsingParameters:(DSAccountManagementService_GetConnectCredentials *)aParameters ;
- (void)GetConnectCredentialsAsyncUsingParameters:(DSAccountManagementService_GetConnectCredentials *)aParameters  delegate:(id<DSAccountManagementServiceSoapBindingResponseDelegate>)responseDelegate;
- (DSAccountManagementServiceSoapBindingResponse *)GetEncryptedPasswordUsingParameters:(DSAccountManagementService_GetEncryptedPassword *)aParameters ;
- (void)GetEncryptedPasswordAsyncUsingParameters:(DSAccountManagementService_GetEncryptedPassword *)aParameters  delegate:(id<DSAccountManagementServiceSoapBindingResponseDelegate>)responseDelegate;
- (DSAccountManagementServiceSoapBindingResponse *)GetAccountSettingsUsingParameters:(DSAccountManagementService_GetAccountSettings *)aParameters ;
- (void)GetAccountSettingsAsyncUsingParameters:(DSAccountManagementService_GetAccountSettings *)aParameters  delegate:(id<DSAccountManagementServiceSoapBindingResponseDelegate>)responseDelegate;
- (DSAccountManagementServiceSoapBindingResponse *)UpdateAccountSettingsUsingParameters:(DSAccountManagementService_UpdateAccountSettings *)aParameters ;
- (void)UpdateAccountSettingsAsyncUsingParameters:(DSAccountManagementService_UpdateAccountSettings *)aParameters  delegate:(id<DSAccountManagementServiceSoapBindingResponseDelegate>)responseDelegate;
- (DSAccountManagementServiceSoapBindingResponse *)AuthenticateMemberUsingParameters:(DSAccountManagementService_AuthenticateMember *)aParameters ;
- (void)AuthenticateMemberAsyncUsingParameters:(DSAccountManagementService_AuthenticateMember *)aParameters  delegate:(id<DSAccountManagementServiceSoapBindingResponseDelegate>)responseDelegate;
- (DSAccountManagementServiceSoapBindingResponse *)GetMemberSettingsUsingParameters:(DSAccountManagementService_GetMemberSettings *)aParameters ;
- (void)GetMemberSettingsAsyncUsingParameters:(DSAccountManagementService_GetMemberSettings *)aParameters  delegate:(id<DSAccountManagementServiceSoapBindingResponseDelegate>)responseDelegate;
- (DSAccountManagementServiceSoapBindingResponse *)UpdateMemberSettingsUsingParameters:(DSAccountManagementService_UpdateMemberSettings *)aParameters ;
- (void)UpdateMemberSettingsAsyncUsingParameters:(DSAccountManagementService_UpdateMemberSettings *)aParameters  delegate:(id<DSAccountManagementServiceSoapBindingResponseDelegate>)responseDelegate;
- (DSAccountManagementServiceSoapBindingResponse *)CheckAccountMemberUsingParameters:(DSAccountManagementService_CheckAccountMember *)aParameters ;
- (void)CheckAccountMemberAsyncUsingParameters:(DSAccountManagementService_CheckAccountMember *)aParameters  delegate:(id<DSAccountManagementServiceSoapBindingResponseDelegate>)responseDelegate;
- (DSAccountManagementServiceSoapBindingResponse *)ActivateSalesforceInstanceUsingParameters:(DSAccountManagementService_ActivateSalesforceInstance *)aParameters ;
- (void)ActivateSalesforceInstanceAsyncUsingParameters:(DSAccountManagementService_ActivateSalesforceInstance *)aParameters  delegate:(id<DSAccountManagementServiceSoapBindingResponseDelegate>)responseDelegate;
- (DSAccountManagementServiceSoapBindingResponse *)PingUsingParameters:(DSAccountManagementService_Ping *)aParameters ;
- (void)PingAsyncUsingParameters:(DSAccountManagementService_Ping *)aParameters  delegate:(id<DSAccountManagementServiceSoapBindingResponseDelegate>)responseDelegate;
@end
@interface DSAccountManagementServiceSoapBindingOperation : NSOperation {
	DSAccountManagementServiceSoapBinding *binding;
	DSAccountManagementServiceSoapBindingResponse *response;
	id<DSAccountManagementServiceSoapBindingResponseDelegate> delegate;
	NSMutableData *responseData;
	NSURLConnection *urlConnection;
}
@property (nonatomic, retain) DSAccountManagementServiceSoapBinding *binding;
@property (nonatomic, readonly) DSAccountManagementServiceSoapBindingResponse *response;
@property (nonatomic, assign) id<DSAccountManagementServiceSoapBindingResponseDelegate> delegate;
@property (nonatomic, retain) NSMutableData *responseData;
@property (nonatomic, retain) NSURLConnection *urlConnection;
- (id)initWithBinding:(DSAccountManagementServiceSoapBinding *)aBinding delegate:(id<DSAccountManagementServiceSoapBindingResponseDelegate>)aDelegate;
@end
@interface DSAccountManagementServiceSoapBinding_UpgradeRecipientAccount : DSAccountManagementServiceSoapBindingOperation {
...
;
@end
@interface DSAccountManagementServiceSoapBinding_NewAccount : DSAccountManagementServiceSoapBindingOperation {
...
;
@end
@interface DSAccountManagementServiceSoapBinding_AddMembersToAccount : DSAccountManagementServiceSoapBindingOperation {
...
;
@end
@interface DSAccountManagementServiceSoapBinding_GetPlanPricingInformation : DSAccountManagementServiceSoapBindingOperation {
...
;
@end
@interface DSAccountManagementServiceSoapBinding_GetSuccessorPlanInformation : DSAccountManagementServiceSoapBindingOperation {
...
;
@end
@interface DSAccountManagementServiceSoapBinding_GetPlanGroupInformation : DSAccountManagementServiceSoapBindingOperation {
...
;
@end
@interface DSAccountManagementServiceSoapBinding_GetMembershipSummary : DSAccountManagementServiceSoapBindingOperation {
...
;
@end
@interface DSAccountManagementServiceSoapBinding_ChangeAccountPricePlan : DSAccountManagementServiceSoapBindingOperation {
...
;
@end
@interface DSAccountManagementServiceSoapBinding_GetProvisioningInformation : DSAccountManagementServiceSoapBindingOperation {
...
;
@end
@interface DSAccountManagementServiceSoapBinding_SetConnectCredentials : DSAccountManagementServiceSoapBindingOperation {
...
;
@end
@interface DSAccountManagementServiceSoapBinding_GetPlanType : DSAccountManagementServiceSoapBindingOperation {
...
;
@end
@interface DSAccountManagementServiceSoapBinding_GetAccountInformation : DSAccountManagementServiceSoapBindingOperation {
...
;
@end
@interface DSAccountManagementServiceSoapBinding_GetAccountDistributorCode : DSAccountManagementServiceSoapBindingOperation {
...
;
@end
@interface DSAccountManagementServiceSoapBinding_GetConnectCredentials : DSAccountManagementServiceSoapBindingOperation {
...
;
@end
@interface DSAccountManagementServiceSoapBinding_GetEncryptedPassword : DSAccountManagementServiceSoapBindingOperation {
...
;
@end
@interface DSAccountManagementServiceSoapBinding_GetAccountSettings : DSAccountManagementServiceSoapBindingOperation {
...
;
@end
@interface DSAccountManagementServiceSoapBinding_UpdateAccountSettings : DSAccountManagementServiceSoapBindingOperation {
...
;
@end
@interface DSAccountManagementServiceSoapBinding_AuthenticateMember : DSAccountManagementServiceSoapBindingOperation {
...
;
@end
@interface DSAccountManagementServiceSoapBinding_GetMemberSettings : DSAccountManagementServiceSoapBindingOperation {
...
;
@end
@interface DSAccountManagementServiceSoapBinding_UpdateMemberSettings : DSAccountManagementServiceSoapBindingOperation {
...
;
@end
@interface DSAccountManagementServiceSoapBinding_CheckAccountMember : DSAccountManagementServiceSoapBindingOperation {
...
;
@end
@interface DSAccountManagementServiceSoapBinding_ActivateSalesforceInstance : DSAccountManagementServiceSoapBindingOperation {
...
;
@end
@interface DSAccountManagementServiceSoapBinding_Ping : DSAccountManagementServiceSoapBindingOperation {
...
@end
@interface DSAccountManagementServiceSoapBindingResponse : NSObject {
	NSArray *headers;
	NSArray *bodyParts;
	NSError *error;
}
...
@end
@class DSAccountManagementServiceSoap12BindingResponse;
@class DSAccountManagementServiceSoap12BindingOperation;
@protocol DSAccountManagementServiceSoap12BindingResponseDelegate <NSObject>
- (void) operation:(DSAccountManagementServiceSoap12BindingOperation *)operation completedWithResponse:(DSAccountManagementServiceSoap12BindingResponse *)response;
@end
#define kServerAnchorCertificates   @"kServerAnchorCertificates"
#define kServerAnchorsOnly          @"kServerAnchorsOnly"
#define kClientIdentity             @"kClientIdentity"
...
#define kNSURLCredentialPersistence @"kNSURLCredentialPersistence"
#define kValidateResult             @"kValidateResult"
@interface DSAccountManagementServiceSoap12Binding : NSObject <DSAccountManagementServiceSoap12BindingResponseDelegate> {
	NSURL *address;
	NSTimeInterval timeout;
	NSMutableArray *cookies;
	NSMutableDictionary *customHeaders;
...
+ (NSTimeInterval) defaultTimeout;
- (id)initWithAddress:(NSString *)anAddress;
- (void)sendHTTPCallUsingBody:(NSString *)body soapAction:(NSString *)soapAction forOperation:(DSAccountManagementServiceSoap12BindingOperation *)operation;
- (void)addCookie:(NSHTTPCookie *)toAdd;
- (NSString *)MIMEType;
- (DSAccountManagementServiceSoap12BindingResponse *)UpgradeRecipientAccountUsingParameters:(DSAccountManagementService_UpgradeRecipientAccount *)aParameters ;
- (void)UpgradeRecipientAccountAsyncUsingParameters:(DSAccountManagementService_UpgradeRecipientAccount *)aParameters  delegate:(id<DSAccountManagementServiceSoap12BindingResponseDelegate>)responseDelegate;
- (DSAccountManagementServiceSoap12BindingResponse *)NewAccountUsingParameters:(DSAccountManagementService_NewAccount *)aParameters ;
- (void)NewAccountAsyncUsingParameters:(DSAccountManagementService_NewAccount *)aParameters  delegate:(id<DSAccountManagementServiceSoap12BindingResponseDelegate>)responseDelegate;
- (DSAccountManagementServiceSoap12BindingResponse *)AddMembersToAccountUsingParameters:(DSAccountManagementService_AddMembersToAccount *)aParameters ;
- (void)AddMembersToAccountAsyncUsingParameters:(DSAccountManagementService_AddMembersToAccount *)aParameters  delegate:(id<DSAccountManagementServiceSoap12BindingResponseDelegate>)responseDelegate;
- (DSAccountManagementServiceSoap12BindingResponse *)GetPlanPricingInformationUsingParameters:(DSAccountManagementService_GetPlanPricingInformation *)aParameters ;
- (void)GetPlanPricingInformationAsyncUsingParameters:(DSAccountManagementService_GetPlanPricingInformation *)aParameters  delegate:(id<DSAccountManagementServiceSoap12BindingResponseDelegate>)responseDelegate;
- (DSAccountManagementServiceSoap12BindingResponse *)GetSuccessorPlanInformationUsingParameters:(DSAccountManagementService_GetSuccessorPlanInformation *)aParameters ;
- (void)GetSuccessorPlanInformationAsyncUsingParameters:(DSAccountManagementService_GetSuccessorPlanInformation *)aParameters  delegate:(id<DSAccountManagementServiceSoap12BindingResponseDelegate>)responseDelegate;
- (DSAccountManagementServiceSoap12BindingResponse *)GetPlanGroupInformationUsingParameters:(DSAccountManagementService_GetPlanGroupInformation *)aParameters ;
- (void)GetPlanGroupInformationAsyncUsingParameters:(DSAccountManagementService_GetPlanGroupInformation *)aParameters  delegate:(id<DSAccountManagementServiceSoap12BindingResponseDelegate>)responseDelegate;
- (DSAccountManagementServiceSoap12BindingResponse *)GetMembershipSummaryUsingParameters:(DSAccountManagementService_GetMembershipSummary *)aParameters ;
- (void)GetMembershipSummaryAsyncUsingParameters:(DSAccountManagementService_GetMembershipSummary *)aParameters  delegate:(id<DSAccountManagementServiceSoap12BindingResponseDelegate>)responseDelegate;
- (DSAccountManagementServiceSoap12BindingResponse *)ChangeAccountPricePlanUsingParameters:(DSAccountManagementService_ChangeAccountPricePlan *)aParameters ;
- (void)ChangeAccountPricePlanAsyncUsingParameters:(DSAccountManagementService_ChangeAccountPricePlan *)aParameters  delegate:(id<DSAccountManagementServiceSoap12BindingResponseDelegate>)responseDelegate;
- (DSAccountManagementServiceSoap12BindingResponse *)GetProvisioningInformationUsingParameters:(DSAccountManagementService_GetProvisioningInformation *)aParameters ;
- (void)GetProvisioningInformationAsyncUsingParameters:(DSAccountManagementService_GetProvisioningInformation *)aParameters  delegate:(id<DSAccountManagementServiceSoap12BindingResponseDelegate>)responseDelegate;
- (DSAccountManagementServiceSoap12BindingResponse *)SetConnectCredentialsUsingParameters:(DSAccountManagementService_SetConnectCredentials *)aParameters ;
- (void)SetConnectCredentialsAsyncUsingParameters:(DSAccountManagementService_SetConnectCredentials *)aParameters  delegate:(id<DSAccountManagementServiceSoap12BindingResponseDelegate>)responseDelegate;
- (DSAccountManagementServiceSoap12BindingResponse *)GetPlanTypeUsingParameters:(DSAccountManagementService_GetPlanType *)aParameters ;
- (void)GetPlanTypeAsyncUsingParameters:(DSAccountManagementService_GetPlanType *)aParameters  delegate:(id<DSAccountManagementServiceSoap12BindingResponseDelegate>)responseDelegate;
- (DSAccountManagementServiceSoap12BindingResponse *)GetAccountInformationUsingParameters:(DSAccountManagementService_GetAccountInformation *)aParameters ;
- (void)GetAccountInformationAsyncUsingParameters:(DSAccountManagementService_GetAccountInformation *)aParameters  delegate:(id<DSAccountManagementServiceSoap12BindingResponseDelegate>)responseDelegate;
- (DSAccountManagementServiceSoap12BindingResponse *)GetAccountDistributorCodeUsingParameters:(DSAccountManagementService_GetAccountDistributorCode *)aParameters ;
- (void)GetAccountDistributorCodeAsyncUsingParameters:(DSAccountManagementService_GetAccountDistributorCode *)aParameters  delegate:(id<DSAccountManagementServiceSoap12BindingResponseDelegate>)responseDelegate;
- (DSAccountManagementServiceSoap12BindingResponse *)GetConnectCredentialsUsingParameters:(DSAccountManagementService_GetConnectCredentials *)aParameters ;
- (void)GetConnectCredentialsAsyncUsingParameters:(DSAccountManagementService_GetConnectCredentials *)aParameters  delegate:(id<DSAccountManagementServiceSoap12BindingResponseDelegate>)responseDelegate;
- (DSAccountManagementServiceSoap12BindingResponse *)GetEncryptedPasswordUsingParameters:(DSAccountManagementService_GetEncryptedPassword *)aParameters ;
- (void)GetEncryptedPasswordAsyncUsingParameters:(DSAccountManagementService_GetEncryptedPassword *)aParameters  delegate:(id<DSAccountManagementServiceSoap12BindingResponseDelegate>)responseDelegate;
- (DSAccountManagementServiceSoap12BindingResponse *)GetAccountSettingsUsingParameters:(DSAccountManagementService_GetAccountSettings *)aParameters ;
- (void)GetAccountSettingsAsyncUsingParameters:(DSAccountManagementService_GetAccountSettings *)aParameters  delegate:(id<DSAccountManagementServiceSoap12BindingResponseDelegate>)responseDelegate;
- (DSAccountManagementServiceSoap12BindingResponse *)UpdateAccountSettingsUsingParameters:(DSAccountManagementService_UpdateAccountSettings *)aParameters ;
- (void)UpdateAccountSettingsAsyncUsingParameters:(DSAccountManagementService_UpdateAccountSettings *)aParameters  delegate:(id<DSAccountManagementServiceSoap12BindingResponseDelegate>)responseDelegate;
- (DSAccountManagementServiceSoap12BindingResponse *)AuthenticateMemberUsingParameters:(DSAccountManagementService_AuthenticateMember *)aParameters ;
- (void)AuthenticateMemberAsyncUsingParameters:(DSAccountManagementService_AuthenticateMember *)aParameters  delegate:(id<DSAccountManagementServiceSoap12BindingResponseDelegate>)responseDelegate;
- (DSAccountManagementServiceSoap12BindingResponse *)GetMemberSettingsUsingParameters:(DSAccountManagementService_GetMemberSettings *)aParameters ;
- (void)GetMemberSettingsAsyncUsingParameters:(DSAccountManagementService_GetMemberSettings *)aParameters  delegate:(id<DSAccountManagementServiceSoap12BindingResponseDelegate>)responseDelegate;
- (DSAccountManagementServiceSoap12BindingResponse *)UpdateMemberSettingsUsingParameters:(DSAccountManagementService_UpdateMemberSettings *)aParameters ;
- (void)UpdateMemberSettingsAsyncUsingParameters:(DSAccountManagementService_UpdateMemberSettings *)aParameters  delegate:(id<DSAccountManagementServiceSoap12BindingResponseDelegate>)responseDelegate;
- (DSAccountManagementServiceSoap12BindingResponse *)CheckAccountMemberUsingParameters:(DSAccountManagementService_CheckAccountMember *)aParameters ;
- (void)CheckAccountMemberAsyncUsingParameters:(DSAccountManagementService_CheckAccountMember *)aParameters  delegate:(id<DSAccountManagementServiceSoap12BindingResponseDelegate>)responseDelegate;
- (DSAccountManagementServiceSoap12BindingResponse *)ActivateSalesforceInstanceUsingParameters:(DSAccountManagementService_ActivateSalesforceInstance *)aParameters ;
- (void)ActivateSalesforceInstanceAsyncUsingParameters:(DSAccountManagementService_ActivateSalesforceInstance *)aParameters  delegate:(id<DSAccountManagementServiceSoap12BindingResponseDelegate>)responseDelegate;
- (DSAccountManagementServiceSoap12BindingResponse *)PingUsingParameters:(DSAccountManagementService_Ping *)aParameters ;
- (void)PingAsyncUsingParameters:(DSAccountManagementService_Ping *)aParameters  delegate:(id<DSAccountManagementServiceSoap12BindingResponseDelegate>)responseDelegate;
@end
@interface DSAccountManagementServiceSoap12BindingOperation : NSOperation {
	DSAccountManagementServiceSoap12Binding *binding;
	DSAccountManagementServiceSoap12BindingResponse *response;
	id<DSAccountManagementServiceSoap12BindingResponseDelegate> delegate;
	NSMutableData *responseData;
	NSURLConnection *urlConnection;
}
@property (nonatomic, retain) DSAccountManagementServiceSoap12Binding *binding;
@property (nonatomic, readonly) DSAccountManagementServiceSoap12BindingResponse *response;
@property (nonatomic, assign) id<DSAccountManagementServiceSoap12BindingResponseDelegate> delegate;
@property (nonatomic, retain) NSMutableData *responseData;
@property (nonatomic, retain) NSURLConnection *urlConnection;
- (id)initWithBinding:(DSAccountManagementServiceSoap12Binding *)aBinding delegate:(id<DSAccountManagementServiceSoap12BindingResponseDelegate>)aDelegate;
@end
@interface DSAccountManagementServiceSoap12Binding_UpgradeRecipientAccount : DSAccountManagementServiceSoap12BindingOperation {
	DSAccountManagementService_UpgradeRecipientAccount * parameters;
}
@property (nonatomic, retain) DSAccountManagementService_UpgradeRecipientAccount * parameters;
- (id)initWithBinding:(DSAccountManagementServiceSoap12Binding *)aBinding delegate:(id<DSAccountManagementServiceSoap12BindingResponseDelegate>)aDelegate
...
;
@end
@interface DSAccountManagementServiceSoap12Binding_NewAccount : DSAccountManagementServiceSoap12BindingOperation {
	DSAccountManagementService_NewAccount * parameters;
}
@property (nonatomic, retain) DSAccountManagementService_NewAccount * parameters;
- (id)initWithBinding:(DSAccountManagementServiceSoap12Binding *)aBinding delegate:(id<DSAccountManagementServiceSoap12BindingResponseDelegate>)aDelegate
...
;
@end
@interface DSAccountManagementServiceSoap12Binding_AddMembersToAccount : DSAccountManagementServiceSoap12BindingOperation {
	DSAccountManagementService_AddMembersToAccount * parameters;
}
@property (nonatomic, retain) DSAccountManagementService_AddMembersToAccount * parameters;
- (id)initWithBinding:(DSAccountManagementServiceSoap12Binding *)aBinding delegate:(id<DSAccountManagementServiceSoap12BindingResponseDelegate>)aDelegate
...
;
@end
@interface DSAccountManagementServiceSoap12Binding_GetPlanPricingInformation : DSAccountManagementServiceSoap12BindingOperation {
	DSAccountManagementService_GetPlanPricingInformation * parameters;
}
@property (nonatomic, retain) DSAccountManagementService_GetPlanPricingInformation * parameters;
- (id)initWithBinding:(DSAccountManagementServiceSoap12Binding *)aBinding delegate:(id<DSAccountManagementServiceSoap12BindingResponseDelegate>)aDelegate
...
;
@end
@interface DSAccountManagementServiceSoap12Binding_GetSuccessorPlanInformation : DSAccountManagementServiceSoap12BindingOperation {
	DSAccountManagementService_GetSuccessorPlanInformation * parameters;
}
@property (nonatomic, retain) DSAccountManagementService_GetSuccessorPlanInformation * parameters;
- (id)initWithBinding:(DSAccountManagementServiceSoap12Binding *)aBinding delegate:(id<DSAccountManagementServiceSoap12BindingResponseDelegate>)aDelegate
...
;
@end
@interface DSAccountManagementServiceSoap12Binding_GetPlanGroupInformation : DSAccountManagementServiceSoap12BindingOperation {
	DSAccountManagementService_GetPlanGroupInformation * parameters;
}
@property (nonatomic, retain) DSAccountManagementService_GetPlanGroupInformation * parameters;
- (id)initWithBinding:(DSAccountManagementServiceSoap12Binding *)aBinding delegate:(id<DSAccountManagementServiceSoap12BindingResponseDelegate>)aDelegate
...
;
@end
@interface DSAccountManagementServiceSoap12Binding_GetMembershipSummary : DSAccountManagementServiceSoap12BindingOperation {
	DSAccountManagementService_GetMembershipSummary * parameters;
}
@property (nonatomic, retain) DSAccountManagementService_GetMembershipSummary * parameters;
- (id)initWithBinding:(DSAccountManagementServiceSoap12Binding *)aBinding delegate:(id<DSAccountManagementServiceSoap12BindingResponseDelegate>)aDelegate
...
;
@end
@interface DSAccountManagementServiceSoap12Binding_ChangeAccountPricePlan : DSAccountManagementServiceSoap12BindingOperation {
	DSAccountManagementService_ChangeAccountPricePlan * parameters;
}
@property (nonatomic, retain) DSAccountManagementService_ChangeAccountPricePlan * parameters;
- (id)initWithBinding:(DSAccountManagementServiceSoap12Binding *)aBinding delegate:(id<DSAccountManagementServiceSoap12BindingResponseDelegate>)aDelegate
...
;
@end
@interface DSAccountManagementServiceSoap12Binding_GetProvisioningInformation : DSAccountManagementServiceSoap12BindingOperation {
	DSAccountManagementService_GetProvisioningInformation * parameters;
}
@property (nonatomic, retain) DSAccountManagementService_GetProvisioningInformation * parameters;
- (id)initWithBinding:(DSAccountManagementServiceSoap12Binding *)aBinding delegate:(id<DSAccountManagementServiceSoap12BindingResponseDelegate>)aDelegate
...
;
@end
@interface DSAccountManagementServiceSoap12Binding_SetConnectCredentials : DSAccountManagementServiceSoap12BindingOperation {
	DSAccountManagementService_SetConnectCredentials * parameters;
}
@property (nonatomic, retain) DSAccountManagementService_SetConnectCredentials * parameters;
- (id)initWithBinding:(DSAccountManagementServiceSoap12Binding *)aBinding delegate:(id<DSAccountManagementServiceSoap12BindingResponseDelegate>)aDelegate
...
;
@end
@interface DSAccountManagementServiceSoap12Binding_GetPlanType : DSAccountManagementServiceSoap12BindingOperation {
	DSAccountManagementService_GetPlanType * parameters;
}
@property (nonatomic, retain) DSAccountManagementService_GetPlanType * parameters;
- (id)initWithBinding:(DSAccountManagementServiceSoap12Binding *)aBinding delegate:(id<DSAccountManagementServiceSoap12BindingResponseDelegate>)aDelegate
...
;
@end
@interface DSAccountManagementServiceSoap12Binding_GetAccountInformation : DSAccountManagementServiceSoap12BindingOperation {
	DSAccountManagementService_GetAccountInformation * parameters;
}
@property (nonatomic, retain) DSAccountManagementService_GetAccountInformation * parameters;
- (id)initWithBinding:(DSAccountManagementServiceSoap12Binding *)aBinding delegate:(id<DSAccountManagementServiceSoap12BindingResponseDelegate>)aDelegate
...
;
@end
@interface DSAccountManagementServiceSoap12Binding_GetAccountDistributorCode : DSAccountManagementServiceSoap12BindingOperation {
	DSAccountManagementService_GetAccountDistributorCode * parameters;
}
@property (nonatomic, retain) DSAccountManagementService_GetAccountDistributorCode * parameters;
- (id)initWithBinding:(DSAccountManagementServiceSoap12Binding *)aBinding delegate:(id<DSAccountManagementServiceSoap12BindingResponseDelegate>)aDelegate
...
;
@end
@interface DSAccountManagementServiceSoap12Binding_GetConnectCredentials : DSAccountManagementServiceSoap12BindingOperation {
	DSAccountManagementService_GetConnectCredentials * parameters;
}
@property (nonatomic, retain) DSAccountManagementService_GetConnectCredentials * parameters;
- (id)initWithBinding:(DSAccountManagementServiceSoap12Binding *)aBinding delegate:(id<DSAccountManagementServiceSoap12BindingResponseDelegate>)aDelegate
...
;
@end
@interface DSAccountManagementServiceSoap12Binding_GetEncryptedPassword : DSAccountManagementServiceSoap12BindingOperation {
	DSAccountManagementService_GetEncryptedPassword * parameters;
}
@property (nonatomic, retain) DSAccountManagementService_GetEncryptedPassword * parameters;
- (id)initWithBinding:(DSAccountManagementServiceSoap12Binding *)aBinding delegate:(id<DSAccountManagementServiceSoap12BindingResponseDelegate>)aDelegate
...
;
@end
@interface DSAccountManagementServiceSoap12Binding_GetAccountSettings : DSAccountManagementServiceSoap12BindingOperation {
	DSAccountManagementService_GetAccountSettings * parameters;
}
@property (nonatomic, retain) DSAccountManagementService_GetAccountSettings * parameters;
- (id)initWithBinding:(DSAccountManagementServiceSoap12Binding *)aBinding delegate:(id<DSAccountManagementServiceSoap12BindingResponseDelegate>)aDelegate
...
;
@end
@interface DSAccountManagementServiceSoap12Binding_UpdateAccountSettings : DSAccountManagementServiceSoap12BindingOperation {
	DSAccountManagementService_UpdateAccountSettings * parameters;
}
@property (nonatomic, retain) DSAccountManagementService_UpdateAccountSettings * parameters;
- (id)initWithBinding:(DSAccountManagementServiceSoap12Binding *)aBinding delegate:(id<DSAccountManagementServiceSoap12BindingResponseDelegate>)aDelegate
...
;
@end
@interface DSAccountManagementServiceSoap12Binding_AuthenticateMember : DSAccountManagementServiceSoap12BindingOperation {
	DSAccountManagementService_AuthenticateMember * parameters;
}
@property (nonatomic, retain) DSAccountManagementService_AuthenticateMember * parameters;
- (id)initWithBinding:(DSAccountManagementServiceSoap12Binding *)aBinding delegate:(id<DSAccountManagementServiceSoap12BindingResponseDelegate>)aDelegate
...
;
@end
@interface DSAccountManagementServiceSoap12Binding_GetMemberSettings : DSAccountManagementServiceSoap12BindingOperation {
	DSAccountManagementService_GetMemberSettings * parameters;
}
@property (nonatomic, retain) DSAccountManagementService_GetMemberSettings * parameters;
- (id)initWithBinding:(DSAccountManagementServiceSoap12Binding *)aBinding delegate:(id<DSAccountManagementServiceSoap12BindingResponseDelegate>)aDelegate
...
;
@end
@interface DSAccountManagementServiceSoap12Binding_UpdateMemberSettings : DSAccountManagementServiceSoap12BindingOperation {
	DSAccountManagementService_UpdateMemberSettings * parameters;
}
@property (nonatomic, retain) DSAccountManagementService_UpdateMemberSettings * parameters;
- (id)initWithBinding:(DSAccountManagementServiceSoap12Binding *)aBinding delegate:(id<DSAccountManagementServiceSoap12BindingResponseDelegate>)aDelegate
...
;
@end
@interface DSAccountManagementServiceSoap12Binding_CheckAccountMember : DSAccountManagementServiceSoap12BindingOperation {
	DSAccountManagementService_CheckAccountMember * parameters;
}
@property (nonatomic, retain) DSAccountManagementService_CheckAccountMember * parameters;
- (id)initWithBinding:(DSAccountManagementServiceSoap12Binding *)aBinding delegate:(id<DSAccountManagementServiceSoap12BindingResponseDelegate>)aDelegate
...
;
@end
@interface DSAccountManagementServiceSoap12Binding_ActivateSalesforceInstance : DSAccountManagementServiceSoap12BindingOperation {
	DSAccountManagementService_ActivateSalesforceInstance * parameters;
}
@property (nonatomic, retain) DSAccountManagementService_ActivateSalesforceInstance * parameters;
- (id)initWithBinding:(DSAccountManagementServiceSoap12Binding *)aBinding delegate:(id<DSAccountManagementServiceSoap12BindingResponseDelegate>)aDelegate
...
;
@end
@interface DSAccountManagementServiceSoap12Binding_Ping : DSAccountManagementServiceSoap12BindingOperation {
	DSAccountManagementService_Ping * parameters;
}
@property (nonatomic, retain) DSAccountManagementService_Ping * parameters;
- (id)initWithBinding:(DSAccountManagementServiceSoap12Binding *)aBinding delegate:(id<DSAccountManagementServiceSoap12BindingResponseDelegate>)aDelegate
...
- (NSString *)serializedFormUsingHeaderElements:(NSDictionary *)headerElements bodyElements:(NSDictionary *)bodyElements bodyKeys:(NSArray *)bodyKeys;
@end
@interface DSAccountManagementServiceSoap12BindingResponse : NSObject {
	NSArray *headers;
	NSArray *bodyParts;
	NSError *error;
}
